...
class OpenImagesDataset:
    ...
    def _getitem(self, index):
        ...
        #logging.info(f"Value of boxes: {boxes}")
    ...
    def _read_data(self):
        ...
        annotation_file = f"{self.root}/{self.dataset_type}/_annotations2.csv"
...
#            logging.info(f"coordinate: xmin: {boxes[:, 0]}, ymin: {boxes[:, 1]}, xmax: {boxes[:, 2]}, ymax: {boxes[:, 3]}")
